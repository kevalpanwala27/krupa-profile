...
const About = () => {
  ...
  return (
    <section id="about" className="section-standard scroll-offset bg-gradient-to-br from-slate-50 via-white to-slate-50 relative overflow-visible md:overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container-balanced relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center mb-12 sm:mb-16 md:mb-20">
          ...
          <motion.div 
            ...
            viewport={{ once: true, amount: 0.3 }}
          >
            <div className="relative w-full h-[300px] sm:h-[400px] md:h-[500px] bg-gradient-to-br from-slate-200 to-slate-300 rounded-2xl sm:rounded-3xl overflow-hidden">
